...
public class EgressProcedure : MonoBehaviour
{
     ...
     * The default values are for dummy testing. 
     */
    ...
    private string ev1_waste;
    private float water_supply;
    // public string ev2_waste;
    private string str_ev1_supply;
    ...
    void BootUpSuit()
    {
        ...
        while (!((TelemetryStreamClient.emu1_pwr_switch == false) && (TelemetryStreamClient.emu1_o2_supply_switch == false) && (TelemetryStreamClient.emu1_water_waste == false)))
        {
